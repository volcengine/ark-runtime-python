...
client = Ark.byteplus()
# The typed parse() helper uses JSON Schema, which requires a model that
# supports strict structured output on Chat Completions.
MODEL = os.environ.get("ARK_MODEL", "seed-2-0-pro-260328")
