...
from ..._exceptions import ArkContentFilterFinishReasonError, ArkLengthFinishReasonError
...
from ...types.chat.chat_completion_message_tool_call_function import (
    ChatCompletionMessageToolCallFunction as Function,
)
    ...
    *,
    ...
    for choice in chat_completion.choices:
        if choice.finish_reason == "length":
            raise ArkLengthFinishReasonError(completion=chat_completion)
...
def maybe_parse_content(
    *,
    ...
    if has_rich_response_format(response_format) and message.content:
