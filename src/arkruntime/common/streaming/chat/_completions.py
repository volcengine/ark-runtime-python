...
from ...._exceptions import (
    ArkContentFilterFinishReasonError,
    ArkLengthFinishReasonError,
)
...
from ....types.chat.chat_completion_choice_logprobs import (
    ChatCompletionChoiceLogprobs as ChoiceLogprobs,
)
from ....types.chat.chat_completion_response_format_param import (
    ChatCompletionResponseFormatParam as ResponseFormatParam,
)
from ....types.chat.chat_completion_stream_response_choice import (
    ChatCompletionStreamResponseChoice as ChoiceChunk,
)
            ...
            if choice.finish_reason:
                ...
                if has_parseable_input(response_format=self._response_format, input_tools=self._input_tools):
                    if choice.finish_reason == "length":
                        ...
                        raise ArkLengthFinishReasonError(completion=completion_snapshot)

                    if choice.finish_reason == "content_filter":
                        raise ArkContentFilterFinishReasonError()

            if choice_snapshot.message.content and is_given(self._rich_response_format):
