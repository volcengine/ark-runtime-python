...
from ...types.responses import input_item_list_params_shim as input_item_list_params
from ...types.responses.input_item import InputItem as ResponseItem
...
class InputItems(SyncAPIResource):
    ...
    def with_streaming_response(self) -> InputItemsWithStreamingResponse:
        ...
        See the streaming-response docs on the SDK repo
        """
