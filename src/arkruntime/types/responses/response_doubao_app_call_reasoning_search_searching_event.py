...
class ResponseDoubaoAppCallReasoningSearchSearchingEvent(BaseModel):
    type: Literal["response.doubao_app_call_reasoning_search.searching"]
    item_id: str
    output_index: int
    block_index: Optional[int] = None
    searching_state: Optional[str] = None
    sequence_number: int
