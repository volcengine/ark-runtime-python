...
from .._types import FileTypes, NotGiven, NotGivenOr
...
def is_base64_file_input(obj: object) -> bool:
...
def _insert_sts_token(args, kwargs):
    ...
    if ark_client.api_key is None and model and model.startswith("bot-") and ark_client.ak and ark_client.sk:
    ...
    elif ark_client.api_key is None and model and ark_client.ak and ark_client.sk:
        extra_headers = kwargs.get("extra_headers") if kwargs.get("extra_headers") else {}
        ...
        default_auth_header = {"Authorization": "Bearer " + ark_client._get_endpoint_sts_token(model, project_name)}
        kwargs["extra_headers"] = {**default_auth_header, **extra_headers}
