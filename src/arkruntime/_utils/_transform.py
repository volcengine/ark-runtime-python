...
def _transform_recursive(
    ...
    *,
    ...
    if origin == dict and is_mapping(data):
        # Bare `dict` annotations (no type args) carry no value-type info;
        # fall back to `object` instead of indexing past the end of an
        # empty tuple. Call sites like `files.list` pass `dict` directly
        # to maybe_transform.
